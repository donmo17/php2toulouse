    ...
    <div class="row tm-mb-50">
        <div class="col-md-4 col-12">
            <div class="tm-about-3-col">
                ...
                <p class="mb-4">Integer tristique arcu scelerisque mauris posuere convallis. Fusce egestas ipsum sapien,
                    hendrerit ultricies nisi viverra eget. Vestibulum in tortor eget elit rutrum interdum. </p>
